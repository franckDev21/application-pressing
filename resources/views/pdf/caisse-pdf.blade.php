...
<body>
    ...
    <div class="grid grid-cols-2 gap-4 py-3 border-b border-t">
      <div style="background-color: rgba(22, 183, 183, 0.151)" class="bg-white shadow-md rounded-md px-4 py-4 text-center border-4 border-opacity-40 border-green-500 shadow-white">
        <h1 style="margin-bottom: 2px" class="text-xl font-semibold text-gray-500 ">Montant total en caisse</h1>
        <span class="w-[40%] mx-auto block h-[1px] bg-green-400 my-2 opacity-20"></span>
        <h2 style="margin: 0; color:rgb(21, 183, 183)" class="font-extrabold text-xl text-green-500">{{ number_format($total, 0, ',', '  ') }} FCFA</h2>
      </div>
    </div>

    @empty($caisses)
        <div class="p-4 rounded-md bg-red-100 text-red-400 text-4xl text-center font-extrabold">Aucun montant</div>
    @else
