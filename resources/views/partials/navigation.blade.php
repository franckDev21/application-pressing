        ...
        <div class="flex items-center justify-between">
            <div class="flex w-2/3 items-center justify-start">
                ...
                <a href="https://demo.themesberg.com/windster/" class="text-xl font-bold flex items-center lg:ml-2.5">
                    {{-- <img src="https://demo.themesberg.com/windster/images/logo.svg" class="h-6 mr-2"
                        alt="Windster Logo"> --}}
                    <span class="self-center whitespace-nowrap text-gray-500 font-extrabold text-3xl">
            ...
            <div class="flex items-center">
                ...
                <form class="inline" method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit"
                        class="hidden sm:inline-flex ml-5 text-cyan-500 border-cyan-500 border-2 bg-white hover:bg-gray-700 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
                        Logout 
                    </button>
                </form>
